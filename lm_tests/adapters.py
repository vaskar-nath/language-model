...
def run_transformer_lm(
    ...
    """
    lm = TransformerLM(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, attn_pdrop, residual_pdrop, device='cpu')
    ...
    Returns:
        Tuple of (vocab, merges):
            ...
            merges: list[tuple[bytes, bytes]]
                ...
                Merges are ordered by order of creation.
    """
    return optmized_train_bpe(input_path, vocab_size, special_tokens)
